...
% CJK Support - Only loaded for Japanese/Chinese/Korean
$if(usecjk)$
\usepackage{xeCJK}
...
% Set main fonts for Latin text (only override if explicitly provided)
$if(mainfont)$
...
% Fix for pandoc longtable caption suppression (requires a 'none' counter)
\makeatletter
\@ifundefined{c@none}{\newcounter{none}}{}
\makeatother
